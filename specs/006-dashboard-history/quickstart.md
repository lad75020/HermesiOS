# Quickstart: Validate Dashboard History Search

## Static Validation

1. Confirm each scoped path exists: HermesiOS/HermesDashboardHistorySearch.swift, HermesiOS/HermesHistoryView.swift.
...
1. Open HermesiOS and navigate to the Dashboard History Search surface if available.
