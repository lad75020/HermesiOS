# Implementation Plan: Host Services and Installation

**Branch**: `feature/time-machine-host-services-installation` | **Date**: 2026-06-21 | **Spec**: [spec.md](./spec.md)

**Input**: Feature specification from `/specs/008-host-services-installation/spec.md`

## Summary

Retroactively document and validate Host Services and Installation. The feature already exists in the HermesiOS source tree, so implementation focuses on scoped artifact generation, source-file existence and pattern checks, no-placeholder validation, and preserving the successful Xcode build baseline.
...
**Scale/Scope**: 6 scoped source/resource paths
...
```text
specs/008-host-services-installation/
├── spec.md
├── plan.md
├── research.md
├── data-model.md
...
HermesHostCompanion/CompanionLogRegistry.swift
HermesHostCompanion/CompanionTailscaleServeRegistry.swift
HermesHostCompanion/CompanionGitRegistry.swift
scripts/deploy-hermesios.mjs
scripts/deploy_hermesios_stack.py
```
...
- Observable behavior contract: [contracts/host-services-contract.md](./contracts/host-services-contract.md)
