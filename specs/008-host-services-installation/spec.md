# Feature Specification: Host Services and Installation

**Feature Branch**: `feature/time-machine-host-services-installation`

**Created**: 2026-06-21

**Status**: Draft

**Input**: User description: "Feature: Host Services and Installation. Description: Manages macOS service records, logs, Tailscale Serve exposure, Hermes Agent update operations, deployment scripts, and service-oriented host actions.. Relevant files: HermesHostCompanion/CompanionServiceRegistry.swift, HermesHostCompanion/CompanionLogRegistry.swift, HermesHostCompanion/CompanionTailscaleServeRegistry.swift, HermesHostCompanion/CompanionGitRegistry.swift, scripts/deploy-hermesios.mjs, scripts/deploy_hermesios_stack.py. Focus on this feature only; do not modify other features."

## User Scenarios & Testing *(mandatory)*

### User Story 1 - Inspect host service state (Priority: P1)

As a HermesiOS user, I want users can see managed Hermes service records and logs. so that this part of the companion app is understandable, reliable, and safe.

**Why this priority**: This journey is required to deliver the user value described by Host Services and Installation while keeping the feature bounded to its source files.
...
---
### User Story 2 - Control deployment exposure (Priority: P2)

As a HermesiOS user, I want users can manage Tailscale Serve and deployment helper flows. so that this part of the companion app is understandable, reliable, and safe.
...
---
### User Story 3 - Update Hermes safely (Priority: P3)

As a HermesiOS user, I want users can check and apply Hermes Agent installation updates with clear conflict handling. so that this part of the companion app is understandable, reliable, and safe.
...
- **FR-001**: The system MUST provide the user-facing capability described by Host Services and Installation using the scoped source files for this feature.
...
- **Managed Service**: Product-level concept used by Host Services and Installation with stable identity, user-visible state, and validation rules.
- **Log Request**: Product-level concept used by Host Services and Installation with stable identity, user-visible state, and validation rules.
- **Tailscale Serve Rule**: Product-level concept used by Host Services and Installation with stable identity, user-visible state, and validation rules.
- **Git Update Operation**: Product-level concept used by Host Services and Installation with stable identity, user-visible state, and validation rules.

## Success Criteria *(mandatory)*

### Measurable Outcomes

- **SC-001**: A user can reach the primary Host Services and Installation surface from the app shell in under 2 seconds after the app is responsive.
