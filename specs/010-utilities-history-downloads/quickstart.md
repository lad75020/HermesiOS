# Quickstart: Validate Utilities, History, and Downloads

## Static Validation

1. Confirm each scoped path exists: HermesiOS/HermesUtilitiesView.swift, HermesiOS/Item.swift.
...
1. Open HermesiOS and navigate to the Utilities, History, and Downloads surface if available.
