# Quickstart: Validate Developer Debug Bridge

## Static Validation

1. Confirm each scoped path exists: HermesiOS/GstackDebugBridges.swift, HermesiOS/GstackDebugStateServer.swift.
...
1. Open HermesiOS and navigate to the Developer Debug Bridge surface if available.
